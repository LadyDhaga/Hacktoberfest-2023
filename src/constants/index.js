...
const experiences = [
  {
    ...
    points: [
      "Open source contributor for the repository of Wikimedia Foundation, for GSOC 2022",
  ...
  // },
  {
    ...
    points: [
      ...
      "Collaborated with 4 Core members to successfully host bootcamps and seminars for fellow developers.",
      //"Implementing responsive design and ensuring cross-browser compatibility.",
...
const projects = [
  {
    name: "Plastick",
    description:
      "A Web-based platform that allows users to recycle any plastic waste product they generate in their households through an app based platform in return of amazing cashbacks and offers.",
    tags: [
      {
        name: "kotlin",
  ...
  },
  {
    name: "Minesweeper",
    description:
      "Immerse yourself in the captivating world of Minesweeper game, made in Kotlin and featuring immersive gameplay and challenging puzzles for an amazing maze solving experience.",
    tags: [
      {
        name: "kotlin",
        color: "blue-text-gradient",
